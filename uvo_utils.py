...
from datasets.DetectionLoader import Detection
...
def get_uvo(root, image_set, transforms, mode='instances', toBinary=False, subset="all"):
    """
...
if __name__ == "__main__":
    ...
    dataset_train = get_coco("/checkpoint/tarun05/data/UVO/", "val", presets.DetectionPresetTrain("hflip"), subset="coco")
