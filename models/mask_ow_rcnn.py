...
from models.grouping import GroupingLayer
...
__all__ = [
    "MaskRCNN", "maskrcnn_resnet50_fpn", "maskrcnn_resnet101_fpn", "maskrcnn_resnet152_fpn", "maskrcnn_resnet18_fpn"
]
...
class MaskRCNN(FasterRCNN):
    ...
    def __init__(self, backbone, num_classes=None,
        ...
        if mask_predictor is None:
            ...
            score_predictor = MaskRCNNScorePredictor(mask_predictor_in_channels)
...
class MaskRCNNScorePredictor(nn.Module):
    def __init__(self, in_channels):

        super().__init__()
        self.conv = nn.Conv2d(in_channels, in_channels, kernel_size=3, 
                    stride=1, padding=1, dilation=1)
        self.fc1 = nn.Linear(in_channels*14*14, 256)
...
def maskrcnn_resnet18_fpn(pretrained=False, progress=True,
                          num_classes=91, pretrained_backbone=True, trainable_backbone_layers=None, **kwargs):
    """
    Constructs a Mask R-CNN model with a ResNet-50-FPN backbone.
